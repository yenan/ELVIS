  ...
  return (
    <div className="cnn-editor">
      <div className="layers">
        {props.architecture.map((layer, index) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="layer-grid">
              ...
              <div className="field">
                ...
                >
                  <option value="conv2d">Conv</option>
                ...
                <>
                  ...
                  <div className="field">
                    ...
                    <input
                      ...
                      value={layer.kernel}
                      onChange={(e) =>
                        updateLayer(index, "kernel", Number(e.target.value))
                      }
                    />
                  </div>
                ...
                <>
                  <div className="field">
                    ...
                    <input
                      ...
                      value={layer.size}
                      onChange={(e) =>
                        updateLayer(index, "size", Number(e.target.value))
                      }
                    />
                  </div>
